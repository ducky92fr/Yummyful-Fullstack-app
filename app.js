...
const MONGODB_URI = `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@cluster0-owbdv.mongodb.net/${process.env.MONGO_DEFAULT_DATABASE}?retryWrites=true`
const app = express();
